namespace InsanKaynaklari.Migrations
{
    ...
    public partial class Ilk : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DepartmanAd = c.String(nullable: false, maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        PersonelAd = c.String(nullable: false, maxLength: 50),
                        PersonelSoyad = c.String(nullable: false, maxLength: 50),
                        PersonelEmail = c.String(nullable: false, maxLength: 200),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Personeller", "DepartmanId", "dbo.Departmanlar");
            ...
            DropIndex("dbo.Personeller", new[] { "DepartmanId" });
